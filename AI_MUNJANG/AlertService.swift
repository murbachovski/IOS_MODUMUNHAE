...
class AlertService {
    ...
    func alert(title:String, body:String, cancelTitle:String, confirTitle:String, thirdButtonCompletion:@escaping ()->Void, fourthButtonCompletion:@escaping ()->Void) -> CustomAlertViewController {
