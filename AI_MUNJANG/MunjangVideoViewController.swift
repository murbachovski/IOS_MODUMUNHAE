...
import UIKit
import AVKit
class MunjangVideoViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        guard let path = Bundle.main.path(forResource: "videoMunjangContents", ofType: "json") else {
            return
        }
